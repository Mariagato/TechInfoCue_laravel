    ...
    <div class="center-block w-xxl w-auto-xs p-v-md">
        <div class="navbar">
            <div class="navbar-brand m-t-lg text-center">
                <a href="{{ route('home') }}"><img src="{{ asset('images/log_u2.png') }}" width="100"
                        style="vertical-align:middle"></a>
            </div>
            <span class="m-l inline text-white"></span>
        ...
        <div class="p-lg panel md-whiteframe-z1 text-color m">
            <form method="POST" action="{{ route('login') }}">
                ...
                <button md-ink-ripple type="submit" class="md-btn md-raised btn-main btn-block p-h-md">Ingresar
                </button>
