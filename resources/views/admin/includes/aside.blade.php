                            ...
                            <nav ui-nav>
                                <ul class="nav">
                                    ...
                                    <li class="{{check_item_active('main_li','contents')}}">
                                        ...
                                        <ul class="nav nav-sub">
                                            <li class="{{check_item_active('inner_li_add','contents','edit')}}">
                                                <a href="{{route('contents.edit',['id'=>0])}}">Agregar contenido</a>
                                            </li>
                                            <li class="{{check_item_active('inner_li_list','contents','list,edit')}}">
                                    ...
                                    <li class="{{check_item_active('main_li','services')}}">
                                        ...
                                        <ul class="nav nav-sub">
                                            <li class="{{check_item_active('inner_li_add','services','edit')}}">
                                                <a href="{{route('services.edit',['id'=>0])}}">Agregar servicio</a>
                                            </li>
                                            <li class="{{check_item_active('inner_li_list','services','list,edit')}}">
                                    ...
                                    <li class="{{check_item_active('main_li','articles')}}">
                                        ...
                                        <ul class="nav nav-sub">
                                            <li class="{{check_item_active('inner_li_add','articles','edit')}}">
                                                <a href="{{route('articles.edit',['id'=>0])}}">Agregar artículo</a>
                                            </li>
                                    ...
                                    <li class="{{check_item_active('main_li','locations')}}">
                                        ...
                                        <ul class="nav nav-sub">
                                            <li class="{{check_item_active('inner_li_add','locations','edit')}}">
                                                <a href="{{route('locations.edit',['id'=>0])}}">Agregar oficina</a>
                                            </li>
                                            <li class="{{check_item_active('inner_li_list','locations','list,edit')}}">
                                    ...
                                    <li class="{{check_item_active('main_li','configsite')}}">
                                        <a md-ink-ripple href="{{route('configsite.edit')}}">
